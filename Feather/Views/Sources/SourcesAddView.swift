...
struct SourcesAddView: View {
	...
	let recommendedSources: [URL] = [
		"https://raw.githubusercontent.com/akameslayer/Feather/refs/heads/main/app-repo.json",
			...
			Form {
				...
				if !_filteredRecommendedSourcesData.isEmpty {
					NBSection(.localized("Featured")) {
						...
						Text(.localized("Open an [issue](https://github.com/akameslayer/Feather/issues) on GitHub if you want your source to be featured."))
					}
				}
			}
			.toolbar {
