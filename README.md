...
[![GitHub Release](https://img.shields.io/github/v/release/calvinmoon/Feather?include_prereleases)](https://github.com/calvinmoon/Feather/releases)
[![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/calvinmoon/Feather/total)](https://github.com/calvinmoon/Feather/releases)
[![GitHub License](https://img.shields.io/github/license/calvinmoon/Feather?color=%23C96FAD)](https://github.com/calvinmoon/Feather/blob/main/LICENSE)
...
Visit [releases](https://github.com/calvinmoon/Feather/releases) and get the latest `.ipa`.

<a href="https://celloserenity.github.io/altdirect/?url=https://raw.githubusercontent.com/calvinmoon/Feather/refs/heads/main/app-repo.json" target="_blank">
   <img src="https://github.com/CelloSerenity/altdirect/blob/main/assets/png/AltSource_Blue.png?raw=true" alt="Add AltSource" width="200">
</a>
<a href="https://github.com/calvinmoon/Feather/releases/latest/download/Feather.ipa" target="_blank">
...
This is a fork of [claration/Feather](https://github.com/claration/Feather).
...
This project is licensed under the GPL-3.0 license. You can see the full details of the license [here](https://github.com/calvinmoon/Feather/blob/main/LICENSE). It's under this specific license because I wanted to make a project that is transparent to the user thats related to certificate paired sideloading, before this project there weren't any open source projects that filled in this gap.
