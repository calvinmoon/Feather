...
[![GitHub Release](https://img.shields.io/github/v/release/calvinmoon/Featherwright?include_prereleases)](https://github.com/calvinmoon/Featherwright/releases)
[![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/calvinmoon/Featherwright/total)](https://github.com/calvinmoon/Featherwright/releases)
[![GitHub License](https://img.shields.io/github/license/calvinmoon/Featherwright?color=%23C96FAD)](https://github.com/calvinmoon/Featherwright/blob/main/LICENSE)
...
Check the [commit history](https://github.com/calvinmoon/Featherwright/commits/main/) for the latest.

## Download

Visit [releases](https://github.com/calvinmoon/Featherwright/releases) and get the latest `.ipa`.

<a href="https://celloserenity.github.io/altdirect/?url=https://raw.githubusercontent.com/calvinmoon/Featherwright/refs/heads/main/app-repo.json" target="_blank">
   <img src="https://github.com/CelloSerenity/altdirect/blob/main/assets/png/AltSource_Blue.png?raw=true" alt="Add AltSource" width="200">
</a>
<a href="https://github.com/calvinmoon/Featherwright/releases/latest/download/Feather.ipa" target="_blank">
...
This project is licensed under the GPL-3.0 license. You can see the full details of the license [here](https://github.com/calvinmoon/Featherwright/blob/main/LICENSE). It's under this specific license because I wanted to make a project that is transparent to the user thats related to certificate paired sideloading, before this project there weren't any open source projects that filled in this gap.
